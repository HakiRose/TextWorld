...
class NewLiteralAlternative(NewAlternative):
    """
...
class NewAdjectiveNounAlternative(NewLiteralAlternative):
    """
        An alternative that specifies an adjective and a noun as chunk of objects.
    """
...
class MatchAlternative(NewAlternative):
    """
        An alternative that specifies matching names for two objects.
    """

    def __init__(self, lhs: NewAlternative, rhs: NewAlternative):
        self.lhs = lhs
        self.rhs = rhs
...
class ProductionRule:
    ...
    def __init__(self, symbol: str, alternatives: Iterable[NewAlternative]):
        self.symbol = symbol
...
class _Converter(NodeWalker):
    ...
    def walk_Literal(self, node):
        ...
        if value:
            return NewLiteralAlternative(value)
        else:
            # Skip empty literals
            return None

    def walk_AdjectiveNoun(self, node):
        return NewAdjectiveNounAlternative(self.walk(node.adjective), self.walk(node.noun))
